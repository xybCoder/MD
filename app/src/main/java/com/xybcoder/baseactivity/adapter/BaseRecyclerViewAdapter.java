package com.xybcoder.baseactivity.adapter;
...
import com.xybcoder.baseactivity.interfaces.OnItemClickListener;
import com.xybcoder.baseactivity.interfaces.OnItemLongClickListener;
...
/**
 * 继承此adapter,只需要实现bindDataToItemView方法
 * 重写 onCreateViewHolder方法
 * @param <M>
 * @param <VH>
 */
