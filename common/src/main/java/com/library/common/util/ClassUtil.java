...
public class ClassUtil {
    ...
    public static String initStr(String old) {
        String str = old.substring(
                0,
                1).toUpperCase() + old.substring(1);
        return str;
    }
            ...
            while (entrys.hasMoreElements()) {
                ...
                if (entryName.endsWith(".class")) {
                    if (childPackage) {
                        ...
                        if (index != -1) {
                            myPackagePath = entryName.substring(
                                    0,
                                    index);
                        } else {
