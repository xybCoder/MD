...
public class JsonUtil {
     ...
     *         <li>return {@link JsonUtil# getLong(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JsonUtil# getInt(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JsonUtil# getDouble(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     */
    public static double getDouble(String jsonObject, String key, double defaultValue) {
        return getDouble(jsonObject, key, (Double)defaultValue);
    }
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JsonUtil# getString(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
    ...
    public static String getStringCascade(JSONObject jsonObject, String defaultValue, String... keyArray) {
        if (jsonObject == null || ArrayUtil.isEmpty(keyArray)) {
            return defaultValue;
        }
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JsonUtil# getStringArray(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>else parse entry by {@link  MapUtil # putMapNotEmptyKey(Map, String, String)} one by one</li>
     *         </ul>
     */
