...
public class MapUtil {
    ...
    public static Map<String, String> parseKeyAndValueToMap(String source, String keyAndValueSeparator,
        ...
        for (String valueEntity : keyAndValueArray) {
            if (!StringUtil.isEmpty(valueEntity)) {
                ...
                if (seperator != -1) {
                    if (ignoreSpace) {
                        MapUtil.putMapNotEmptyKey(keyAndValueMap, valueEntity.substring(0, seperator).trim(),
                                valueEntity.substring(seperator + 1).trim());
                    } else {
                        MapUtil.putMapNotEmptyKey(keyAndValueMap, valueEntity.substring(0, seperator),
     ...
     * @param ignoreSpace whether ignore space at the begging or end of key and value
     * @return
     * @see {@link MapUtil#parseKeyAndValueToMap(String, String, String, boolean)}, keyAndValueSeparator is
